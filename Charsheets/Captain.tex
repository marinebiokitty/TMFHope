...
\begin{itemz}[Notes]
	...
	\item You know that the \pNew{} has very limited supplies for repairing the ship or any unorthodox operations to try to reverse whatever happened. You should probably get a full inventory of what damages the ship has sustained, what will be required to repair it, and establish a plan, before anyone starts trying to repair anything.
\end{itemz}
