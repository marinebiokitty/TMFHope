...
The only sore spot until now was the military discipline with which the Captian and Executive oFficer sometimes run the ship. It comes and goes in phases, and they feed off each other. Every time it happens, you want to take \cNav{} and abandon ship. But \cEng{} would never leave the \pNew{}, and you can't abandon \cEng{\them} either.

Now of course everything is terrible. The ship is trapped in the middle of a jump somehow, and don't seem to have access to the same places as \cEng{}. Will you be able to fix your parts of the ship without \cEng{\them}? Will \cEng{\they} be able to fix their parts without you?
...
\begin{contacts}
	...
	\contact{\cCap{}} You dislike \cCap{\their} rigid military style. Doesn't \cCap{} know \cCap{\they} were discharged? So bossy!
\end{contacts}
