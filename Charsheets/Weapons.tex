...
\begin{itemz}[Notes]
	...
	\item To try to reinstate ship-wide communications start with the \iWT{} in your posession. Spend 2 minutes in a game space, by yourself, fiddling with the walkie talkie. At the end of this time, go to the ``mechanics-only'' channel, and use the searchcontainer command for ``Packet 2''. Take the ``Modified Walkie Talkie'' item from the packet. Pass that item along to \cBoy{}.
\end{itemz}
