...
Secondly is \cBoy{\full}. You met while trolling the internet some years back, and became pen pals. Occasional emails became messages exchanged daily and soon grew into a close friendship. By the time you graduated, you were committed to finding a way to get \cBoy{} off the backwater space-port \cBoy{\they} \cBoy{\were} stuck on, any chance, right? As luck would have it the \pNew{} scheduled a route through \cBoy{\their} home port. So you and \cBoy{} hatched a plan to get \cBoy{\them} hired on as a deck hand. It was a dicey thing there for a minute. While \cEng{} hit it off with \cBoy{} immediately, \cEng{\their} endless dislike for you nearly scuttled the operation. Still, all's well that ends well.
...
\begin{contacts}
	...
	\contact{\cBoy{}} Your best friend. You helped get \cBoy{\them} a job on \pNew{}.
