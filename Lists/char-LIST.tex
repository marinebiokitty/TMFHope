...
\NEW{PC}{\cCap}{
  ...
  \s\MYitems	{\iKey{}}
  \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mCAlpha{} \mCaptainOne{}\mCaptainTwo{}
  \mPractice{}}
...
\NEW{PC}{\cXO}{
  ...
  \s\MYitems	{\iKey{}}
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mXAlpha{}
   \mThreatOne{}\mThreatTwo{}\mThreatThree{}\mThreatFour{}\mPractice{}   }
...
\NEW{PC}{\cMed}{
  ...
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   ...
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}
   \mMedOne{}\mMedTwo{}\mMedThree{}\mMedFour{}\mMedFive{}\mMedSix{}\mMedSeven{}\mPractice{}  }
...
\NEW{PC}{\cSci}{
  ...
  \s\MYplayer	{Ronan Beltracchi}
   ...
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}
   \mSciOne{}\mSciTwo{}\mSciThree{}\mSciFour{}\mSciFive{}\mSciSix{}\mSciSeven{}\mPractice{}  }
   
  \s\MYcr{1}
}

\NEW{PC}{\cDip}{
  \s\MYname	{Tara Richards}
  ...
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   ...
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mDAlpha{}
   \mDiplomatOne{}\mDiplomatTwo{}\mDiplomatThree{}\mPractice{} }
...
\NEW{PC}{\cWeap}{
  ...
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   ...
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mWAlpha{}
   \mWeaponsOne{}\mWeaponsTwo{}\mWeaponsThree{}\mPractice{} }
	\s\MYitems	{\iWT{}}
...
\NEW{PC}{\cEng}{
  ...
  \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mAlpha{}
   \mRepairsOne{}\mRepairsThree{}\mRepairsFive{}\mEngineerOne{}\mPractice{} }
  
  \s\MYcr{1}
}

\NEW{PC}{\cNav}{
  \s\MYname	{Jacob O'Brien}
  \s\MYfile	{Navigation.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{The Navigator}
  \s\MYsex	{\male}
  \s\MYplayer	{Patrick Braasch}
  
  \s\MYblues	{\bHistory{}\bHope{}}
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   \s\MYabils	{\aCalculate{}\aInvestigation{}}
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mAlpha{}
   \mNavOne{}\mNavTwo{}\mNavThree{}\mNavFour{}\mNavFive{}\mPractice{} }
  
  \s\MYcr{1}
}

\NEW{PC}{\cBoy}{
  \s\MYname	{Annamarie Than}
  ...
  \s\MYplayer	{Sarah Terman}
   ...
   \s\MYmems {\mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}\mAlpha{}
   \mRepairsTwo{}\mRepairsFour{}\mDeckHandOne{}\mPractice{} }
