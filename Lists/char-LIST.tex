...
\NEW{PC}{\cSci}{
  ...
  \s\MYsex	{\female}
  \s\MYplayer	{Veronica Melnick}
  
   \s\MYblues	{\bHistory{}\bHope{}}
   \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   \s\MYabils	{\aEngineering{}}
   \s\MYmems {\mPractice{}
   \mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}
...
\NEW{PC}{\cWeap}{
  \s\MYname	{Christopher Garron} %Christina?
  \s\MYfile	{Weapons.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{The Weapons Officer}
  \s\MYsex	{\male}
  \s\MYplayer	{Rob Wensley}
...
\NEW{PC}{\cEng}{
  \s\MYname	{Sam Jones} %Samantha
  \s\MYfile	{Engineering.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{The Engineer}
  \s\MYsex	{\male}
  \s\MYplayer	{Stefan Melnick}
  
  \s\MYblues	{\bHistory{}\bHope{}}
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
  \s\MYabils	{\aEngineering{}\aEyesight{}}
  \s\MYmems {\mPractice{}\mEAlpha{}\mEngineerOne{} \mRepairsOne{}\mRepairsThree{}\mRepairsFive{}
  \mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}
    }
...
\NEW{PC}{\cNav}{
  ...
  \s\MYblues	{\bHistory{}\bHope{}}
  \s\MYgreens	{\gFixTheShip{}\gDiscord{}}
   \s\MYabils	{\aCalculate{}\aInvestigate{}}
   \s\MYmems {\mPractice{}\mNAlpha{} \mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}
...
\NEW{PC}{\cBoy}{
  \s\MYname	{Alder Than}%Annamarie %Andy
  \s\MYfile	{CabinBoy.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{A new deck hand}
  \s\MYsex	{\nonbinary}
  \s\MYplayer	{Daniel R. Abraham}
	
   \s\MYabils	{\aEngineering{}\aNegotiation{}}
   \s\MYmems {\mPractice{}\mDHAlpha{}\mDeckHandOne{}  \mRepairsTwo{}\mRepairsFour{} \mBroom{}\mLab{}\mPatient{}\mKitchen{}\mWeight{}\mTheater{}\mCrates{}}
