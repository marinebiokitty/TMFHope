...
\NEW{Abil}{\aNegotiation}{
  \s\MYname	{Negotiation}
  \s\MYtext	{\textbf{(3 uses)} This ability allows you to stop combat for 3 minutes in the area you are in. Start a timer, and tell anyone who enters your space this. You carry the effect with you if you change locations. It may have special uses in other circumstances.}
...
\NEW{Abil}{\aTruth}{
  ...
  \s\MYtext	{\textbf{(3 uses)} You have a lot of experience spotting when someone is lying to you. Immediately after someone tells you something, you may use this ability on them to have them tell you (player to player) whether that thing they said was true to the best of their knowledge. Be sure to @ your target when you use this ability.}
...
\NEW{Abil}{\aCalculate}{
  ...
  \s\MYtext	{This ability allows you to install teleporter power crystals in the computer consoles.}
  \s\MYeffect	{You see me working with the teleporter power crystals.}
}

\NEW{Abil}{\aThreat}{
  \s\MYname	{Threat Assessment}
  \s\MYtext	{You may assess a phenomenon in the environment (something on a sign) for whether it is a threat. Signs with relevant information will say ``If you have the ``threat assessment'' ability, you may type $<$a phrase unique to the sign$>$ into your **private channel** to receive an assessment.'' Some players may also be able to give you a phrase that can be used to assess some circumstances as well.}
