...
\NEW{Abil}{\aEyesight}{
  ...
  \s\MYtext	{(Physical limitation) Tasks requiring the engineering skill take you 2x as long unless someone else with the engineering skill is helping (engineering tasks take you 12 minutes by yourself, 6 with someone helping who *does not have* the engineering skill, and 3 minutes if the person helping *does have* the engineering skill. Additionally, You cannot initiate a combat attack (you may still defend and assist). \textbf{You do not need to use this ability at any time, its effects exist at all times.}}
