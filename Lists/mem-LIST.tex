...
\NEW{MemFold}{\mXAlpha}{
  \s\MYname	{Alpha | Trigger: Open 45 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1.}
}

\NEW{MemFold}{\mDAlpha}{
  \s\MYname	{Alpha | Trigger: Open 1 hour after game start.}
  \s\MYtext	{Set your Alpha score to 1.}
}
...
\NEW{MemFold}{\mEAlpha}{
  \s\MYname	{Alpha | Trigger: Open 1 hour and 15 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1.}
}
