...
\NEW{MemFold}{\mMedFive}{
  ...
  \s\MYtext	{You’ll have to go back to the source. Talk to the **Captain** for at least 2 minutes about the apparitions and when they first started seeing the ghosts, until they tell you what happened. || After the Captain tells you what happened, trigger your “Medical Page 6” mem packet.}
}
...
\NEW{MemFold}{\mSciFive}{
  ...
  \s\MYtext	{You’ll have to go back to the source. Talk to the **Captain** for at least 2 minutes about the apparitions and when they first started seeing the ghosts, until they tell you what happened. || After the Captain tells you what happened, trigger your “Science Page 6” mem packet.}
}
...
%% Alpha Reminders
\NEW{MemFold}{\mCAlpha}{
  \s\MYname	{Half Way There | Trigger: Open 10 minutes after game start.}
...
\NEW{MemFold}{\mXAlpha}{
  \s\MYname	{Half Way There | Trigger: Open 40 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1. If it was already at 1, do not change it. Tell other players you encounter to open their ``Half Way There'' packet.}
}

\NEW{MemFold}{\mDAlpha}{
  \s\MYname	{Half Way There | Trigger: Open 50 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1. If it was already at 1, do not change it. Tell other players you encounter to open their ``Half Way There'' packet.}
}

\NEW{MemFold}{\mWAlpha}{
  \s\MYname	{Half Way There | Trigger: Open 60 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1. If it was already at 1, do not change it. Tell other players you encounter to open their ``Half Way There'' packet.}
}

\NEW{MemFold}{\mAlpha}{
  \s\MYname	{Half Way There | Trigger: Open 70 minutes after game start.}
  \s\MYtext	{Set your Alpha score to 1. If it was already at 1, do not change it. Tell other players you encounter to open their ``Half Way There'' packet.}
}
...
\NEW{MemFold}{\mDiplomatTwo}{
  \s\MYname	{Diplomat 2 | Trigger: Open if you are given a 	``Modified Walkie Talkie''.}
