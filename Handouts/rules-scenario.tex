...
\textbf{There are 2 runs of this game scheduled. Make sure you know which one you are playing in so you don't show up at the wrong time.}

\textbf{Run 1:} Game will run from \textbf{5:00pm - 9:00pm PST / 8:00 pm - 12:00am EST} on \textbf{Saturday, Mar 13th}. 

\textbf{Run 2:} Game will run from \textbf{2:00pm - 6:00pm PST / 5:00 pm - 9:00pm EST} on \textbf{Saturday, Mar 20th}. 

\textbf{Game Start:}Players are expected to log on to the``TMF Hope'' Discord server and connect to the ``OOC Channel'' voice channel at the scheduled start time for their run.  Surviving PCs are expected to be in-game on the server for the entirety.  Game may end early.  Wrapup will immediately follow the end of game. \textbf{If you encounter technical difficulties, please CALL the GMs and let us know. Acata: 650-690-5628.}  
...
\textcolor{red}{These 2 little sections are new in the 06Mar2021 version of the rules.}
...
\textcolor{red}{New information has been added to version 06Mar2021 of the rules. If you read a previous version, please pay special attention to this section.}
