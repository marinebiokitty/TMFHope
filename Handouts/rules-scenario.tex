...
The {\bf gamemasters} ({\bf GMs}) run the game.  If you have any problems or questions concerning the game, contact a GM.  The GMs are available before game to clarify any questions you may have about the rules and game. Th GMs will also be available during game, but the more time and atention you put toward understanding the rules and mechanics ahead of time, the less overwhelmed you will likely feel, and the more you are likely to enjoy the game.  Rulings th GMs make are final.  They may violate the letter of the rules to preserve the spirit.  The GMs promise to be as fair and reasonable as possible. Neither they nor these rules are perfect, so we ask for your understanding and flexibility.
...
Thanks is due to Olivia Montoya for writing the Discord Bot that makes this game possible. ``TMF Hope'' is written by Acata Felton (she/her; char.felton@gmail.com) and Olivia Montoya. Please ask for permission before running the game, but also please do take the game and run it for your friends! Playtesting was enabled by the Luminary Roleplay Society, a San Francisco Bay Area 501(c)(3) non-profit that promotes LARPing in the Bay area and at conventions across the United States. If you would like to donate to the upkeep of the discord bot, <INSERT>. If you would like to donate to ongoing LRS activities, you can donate here: \href{https://www.luminaryroleplaysociety.com/donations/}{https://www.luminaryroleplaysociety.com/donations/}. The recommended donation is \$5 to one or the other, or both, source(s).
...
\paragraph{Game Times:} Game runs from {\bf 12:00 pm - 4 pm (PST)} on {\bf Saturday, Jan 30th}. Players are expected to log on to the``TMF Hope'' Discord server and connect to the ``OOC Channel'' voice channel at that time.  Surviving PCs are expected to be in-game on the server for the entirety.  Game may end early.  Wrapup will immediately follow the end of game. {\bf If you encounter technical difficulties, please CALL the GMs and let us know. Acata: 650-690-5628.}  
...
The Discord server contains an OOC category, with several OOC channels for pre and post game chatter. There is also an ``announcements'' channel, that will be used by the GMs before and {\bf during} game to make game-wide annoucements. This is all you will be able to see when you first join. Once you join the server and the GM assigns you your role, you will be able to see the game spaces accessible to your character. You will see 1``Private Channel'' matching your character role, and 2 of the ship spaces (comprised of 1 text channel and 1 voice channel, grouped together and named the same).
...
\begin{itemize}
  \item Reflect on the game scenario and the listed content warnings (see below) before applying. If you have reasons to believe you’ll be activated by game content, consider skipping this game. It’s okay not to play.
  \item Reflect on your emotional reserves right now, and what actions you can take to prepare care for yourself before game to boost your resiliency (i.e.: making sure you get a full night's sleep before game). Consider what preparations you can make for self care after game to replenish (i.e.: ordering your favorite food, or having a stuffed animal nearby for snuggles). This is helpful in case you get unexpectedly activated.
  \item Reflect on the safety mechanics for this game and how you can use them to protect yourself and create space to check in with yourself.
If you need to, leave the game. The door is always open, and if it’s what you need to take care of yourself, do it. But if a less nuclear option feels accessible, we encourage you to try it  first.
\end{itemize}

We will be using the following safety mechanics in game:
\begin{itemize}
  \item ``Brake'' (from ``Cut and Brake'')  - Use this to re-calibate the auditory experience of an interaction for a player’s comfort. I.e.: Ask a player to speak more quietly, even though their character is still yelling. This is not a negotiation - the person being asked to ``brake'' should immediately comply for the comfort and safety of their fellow players. Example: 	\ast Fist on Head in OOC gesture 	\ast. ``Hey Bob, brake. Can you not shout please?''
...
The following content warning applies to all of game. We recommend you skip this game if you don’t want to play a game containing these things.
\begin{enumerate}
  \item Potential for character death
  \item Risk to health and safety
\end{enumreate}

The following content warnings apply to parts of game. It is possible for GMs to cast you in roles away from these topics if you include it in your application that you wish to avoid the topic. (warning: If you need to avoid {\bf all} of these things, this may not be the game for you):
\begin{itemize}
  \item Ex-millitary
...
For the safety and comfort of players and GMs for this game, it is also important that you {\bf do not add} any potentially activating or triggering material to game. Once you get your character, please stay within the bounds outlined by that sheet and the game content in general. Do not invent edgelord backstory elements, or introduce new plot points. In fact, we generally discourage you from inventing new content that isn't suggested in your character sheet. This is important for the integrity of game. If you invent something new and abandon content written for the character, you leave the other characters involved in that content out in the cold. This is also cruicial for the safety of your fellow players since they didn’t get a chance to opt into or out of the new content.

\clearpage
\section{Character Packets}

Information on your your part as a {\bf player-character} ({\bf PC}) and the world they live in will be presented in a series of documents called your ``character packet''. The term comes from in person games where the character information would be printed out and handed to you in a manila envelope - a literal packet. You are expected to be familiar with the contents of your character packet before game. We recommend you keep the various documents handy during the game, possibly on a second screen, or printed out.  If you are missing something or find you've been given something which doesn't seem to belong to you, tell one of the GMs.  Character packets are confidential; please do not share any information you got on these documents with anyone else - in or out of character. You may think two characters should know the same things, but you may inadvertently ruin a major surprise for them.

Your Character Packet should contain:

\paragraph{Character Sheet:} Your character sheet describes who you are and what you are up to.  It contains a list of everything else that should be in your character packet, along with a list of any items, stats, abilities and memory or event triggers (see below) you start with. Do not show or read your character sheet to other players.
...
\paragraph{Abilities:} Some characters have abilities that represent small mechanics. There is  a list of any abilities you have on your character sheet. You will use text-based commands in the Discord server to use your abilities (see below for discord commands).

\paragraph{Memory/Event Trigers:} A memory/event trigger represents your character remembering, or learning something, or something happening to your character. You will have a list of any such starting triggers on your character sheet, but no other information. When something or someone tells you to ``open your <Insert trigger> packet'', you will go to your private channel, and use the bot command `?Trigger <Trigger>'' I.E.: ``?Trigger Alpha''. 

Some memory packets will give you just a piece of information, suggest something, or change a stat. Others may provie information along a line of investigation and proide a new trigger for when the next task is complete. (These replace research notebooks.) Do not take game action based on an unopened trigger.  Do not show or read a memory packet to other players.

\paragraph{Items:} In-game items may be transferred from character to character, as long as the two characters are in the same game space (text channel and voice channel). Some characters start with one or more items in their posession. Some items are {\bf bulky} this means that you must dedicate that many hands to carrying it. Items can have a bulkiness of 0 (not bulky), 1, or 2. Unless you know otherwise (aka: you have a mechanic that says so), you can never carry more than 2 bulkiness-worth of items as you only have 2 hands. If you need 3 bulkiness worth of items to accomplish something, you will need someone else to help you by carrying the 3rd item.

\paragraph{Discord Pinned Message:} In your private channel, you will find a series of pinned messages, with your abilities, starting memory/event triggers, and stats. These give you easy reference to them during game. Your items are not included in this list as they are transerable and no such list would stay accurate for very long.
...
\paragraph{Halts:} A halt pauses game action.  To call one, say ``game halt'' in a clear and audible voice; all players in your voice channel should hear you. End a halt by saying ``three, two, one, resume.''  Call a halt for one of only three reasons: because a rule instructs you to, for safety and similar out-of-game issues (see Non-players section below), or to pause game and wait for a GM (which you should normally not need to do, but a few mechanics may tell you to ``@ the GM role'' aka type ``@GM: <Message>'' into the text channel).
...
abstract mechanics, which are described in ability cards, greensheets, and rules.  The abstract information for mechanics (like badge numbers) may not be discussed in-game.  If you want to do something special for which there is no mechanic, ask a GM.
...
A {\bf kludge} (and derivative forms like ``kludge-ite'') is something impervious to logic and cleverness, usually for game-balance.  You can't affect a kludge without a specified mechanic.
...
%% intro
All characters have a {\bf Combat Rating} ({\bf CR}) stat.  This represents your basic skill in martial combat; you use the same number for attacking and defending (unless you know otherwise).  Someone with a CR of one can't fight very well.  Someone with a CR of three is somewhat burly or skilled. When using this stat, you may pull your punches by using a lower number.

%% offense
To martial-attack someone, clearly state your target, your attack and your CR (``Captain, \aKnockOut{} 2'', ``Medical, \aWound{} 2'', etc.). You must be in the same voice channel with the person you are attacking. Your first attack must resolve before you make another; otherwise, you may act freely (aka you may talk).  If an ally directs {\bf \aAssist{}} at you after you attack, you may, within 2 seconds, restate your attack with the \aAssist{}'s CR added (``Captain \aWound{} 3'', ``Meidical \aAssist{} 2'', ``Captain \aWound{} 5''). You may ignore an \aAssist{}. {\bf You may not assist defense, only attacks}.

Restrain attacks require an item which says that it may be used as rope (you must have the item in your posession). Knock Out and Wound attacks do not require any items.

\paragraph{Rope:} Rope is {\bf not} freely available. You will need to find an item that says it can be used as rope. To tie someone up, they must be either willing, helpless (unconcious or wounded), or you must win a martial-attack against them.  If you get tied up with rope, you become restrained. You are unable to change game spaces (channels) on your own, but can be moved by someone else. Moving someone who is restrained requires 1 hand free (you cannot carry an object with bulkiness 2 at the same time).  If you are conscious and left alone (no one else in the same game space with you), you can wriggle free in five minutes.

%% defense
When martial-attacked, resolve by comparing the attack against your CR.  If your CR is lower, take the effects; else, say ``{\bf resist}'' and the attack has no effect. {\bf Do not state your CR when you resist. Just say ``resist''}.  If you neither say ``resist'' nor state your own attack within two seconds of the incant's end, you are surprised and the attack just works.  Serial attacks don't prevent simple actions (talking) in-between.  Resolve all attacks alone, in the order they occur; choose the order if it is unclear. 

{\bf You may not assist defense, only attacks}. If you have an ally but your CR is not high enough to resist an attack, your best option might be to attempt a counter attack. At best this will leave you and your attacker knocked out or wounded, and your ally can heal you up (or go through your pockets.)

There are no stealth attacks of any kind in this game.

\paragraph{Martial Attack Abilities:} Here is a list of attack abilities.  You should assume that every character has \aKnockOut{}, \aWound{},  \aAssist{}, and \aRestrain{}.  Other attack abilities may exist. Assume you have the ability to use all of these attacks unless you know otherwise (i.e.: your character sheet says ``you may not use {\bf knock out} attacks.'')\nopagebreak
...
Killing blows are a the only ``n-count'' mechanic in this game (it is also the only interruptable mechanic in game). If your character wishes to kill another character, but don't feel like waiting for them to bleed out from a wound attack (or don't want anyone to find them and heal them), you must use the ``Killing Blow'' mechanic. {\bf You must have both hands free, aka not holding any bulky items to perform a killing blow.} If you have a willing or helpless (restrained, knocked out, wounded) victim, you may begin an n-count of 10 by:
\begin{enumerate}
  \item Type into the text channel: ``Captain Killing blow 0'' (Indicating who you are targetting with the mechanic)
...
\begin{itemize}
  \item ``<Character> Brake''
  \item ``Time Out" / ``Time In''
  \item Open Door Policy - please tell a GM if you can if you are leaving permenantly.
\end{itemize}
...
{\bf Reminder: You cannot assist defends.}
...
\begin{enumerate}
  ...
  \item If you have a trigger listed on your character sheet that says ``Enter the following in your private channel at game start.'' Don't forget to do that; it is the start of a research chain that is important to your character.
...
\multicolumn{4}{|c|}{Interacting with the World} \\
\hline
Command & Example & Circumstance  or Effect & Channel to use it in\\
    \hline
   ?search    & ?search    & Search an Area for what you see. It will return a list of signs and containers in the area. &   Game Space Channel\\
    \hline
   Afghanistan   & AF    & Read a Sign &   Game Space Channel\\
    \hline
   Afghanistan   & AF    & Switch a Sign out with another one (changing something in the environment). The sign being changed out will tell you the name of the sign to be changed in. &   Game Space Channel\\
    \hline
  Afghanistan   & AF    & Read a Container, then optionally search it &   Game Space Channel\\
    \hline
...
Command & Example & Circumstance  or Effect & Channel to use it in\\
    \hline
  ?inventory   & ?inventory    & Check your own inventory of items for what you are carrying &   Private Channel\\
    \hline
  ?listitem <itemname>   & ?listitem banana    & Gives you the name, description, and bulkiness of the item &   Private Channel\\
    \hline
  ?drop <itemname>   & ?drop banana    & Move an item from your inventory to a container &   Game Space Channel\\
    \hline
  ?give<@user> <itemname>   & ?give@Captain banana    & Transfer an item in your inventory to the tagged user's inventory. The bot will technically allow you to transfer items between any two characters. {\bf The Game Rule} is that you can only pass items if you are both in the same game space. &   Game Space Channel\\
    \hline

\multicolumn{4}{|c|}{Abilities} \\
\hline
Command & Example & Circumstance  or Effect & Channel to use it in\\
    \hline
  ?abilities   & ?abilities    & list your abilities, their description and their effects &   Private Channel\\
    \hline
  ?abilities   & ?abilities    & list your abilities, their description and their effects &   Private Channel\\
    \hline
 
 
\multicolumn{4}{|c|}{Memory Packets, Event Triggers, and Research Chains} \\
\hline
\multicolumn{4}{|c|}{refer to the pinned messages in your Private channel for the triggers your character starts with.} \\
\hline
Command & Example & Circumstance  or Effect & Channel to use it in\\
    \hline
  ?abilities   & ?abilities    & list your abilities, their description and their effects &   Private Channel\\
